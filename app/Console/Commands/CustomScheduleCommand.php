...
class CustomScheduleCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'schedule:custom';
     ...
     * @var string
     */
    protected $description = 'command to run custom phishing';
            ...
            foreach ($finalEmails as $senderEmail => $recevingEmails) {
                ...
                foreach ($recevingEmails as $email) {
                    ...
                    if ($template->link_text != null && $template->link_url != null) {
                        ...
                        $link = route('open-phishing-url', ['token' => $mailToken ]);
